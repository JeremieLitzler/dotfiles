...
5. Draft a concise commit message focused on the _why_, not the _what_ following conventional commit-style. Use a HEREDOC so formatting is preserved. End the message with: `Co-Authored-By: Claude <noreply@anthropic.com>`
